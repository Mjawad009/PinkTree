...
// ILLUSTRATIVE TESTIMONIALS — I don't have access to your real clients, so
...
// from real people — replace every one with a genuine, permissioned client
...
const testimonials = [
  {
    quote: "Pink Tree scoped this around how we actually work, not a generic template. Our consultants got their time back within the first month.",
    author: "Renata Solis",
    role: "Managing Director",
    company: "Meridian Visa Partners",
    metric: { value: "65%", label: "Questions resolved before a call" },
  },
  {
    quote: "It's the first knowledge system where I actually trust the answer, because it shows me exactly which document it came from.",
    author: "Dr. Kenji Osei",
    role: "Research Operations Lead",
    company: "Brightwell Research Institute",
    metric: { value: "6 hrs/week", label: "Less time spent searching" },
  },
  {
    quote: "We came in wanting a chatbot. Pink Tree told us that wasn't actually the bottleneck, and scoped the automation that was.",
    author: "Owen Baptiste",
    role: "Operations Lead",
    company: "Fernhill Logistics",
    metric: { value: "3 days to 4 hrs", label: "Faster process turnaround" },
  },
  {
    quote: "As an organization handling sensitive applicant data, compliance was non-negotiable. This gave us full confidence from day one.",
    author: "Yasmin Adeyemi",
        ...
        <div className="flex items-center justify-between mb-20">
          <div>
            ...
            <h2 className={`text-4xl lg:text-5xl font-display transition-all duration-1000 ${
              ...
              Real businesses.
              <span className="text-background/40"> Real results.</span>
            </h2>
          </div>
